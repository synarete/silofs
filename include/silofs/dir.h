...
int silofs_lookup_dentry(const struct silofs_fs_ctx *fsc,
                         struct silofs_inode_info *dir_ii,
                         const struct silofs_qstr *name,
                         struct silofs_ino_dt *out_idt);

int silofs_add_dentry(const struct silofs_fs_ctx *fsc,
                      struct silofs_inode_info *dir_ii,
                      const struct silofs_qstr *name,
                      struct silofs_inode_info *ii);

int silofs_remove_dentry(const struct silofs_fs_ctx *fsc,
                         struct silofs_inode_info *dir_ii,
                         const struct silofs_qstr *name);

int silofs_do_readdir(const struct silofs_fs_ctx *fsc,
                      struct silofs_inode_info *dir_ii,
                      struct silofs_readdir_ctx *rd_ctx);

int silofs_do_readdirplus(const struct silofs_fs_ctx *fsc,
                          struct silofs_inode_info *dir_ii,
                          struct silofs_readdir_ctx *rd_ctx);
