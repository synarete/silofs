...
#define SILOFS_ENOREF           SILOFS_DEFERR2(3)
#define SILOFS_EBADREF          SILOFS_DEFERR2(4)
#define SILOFS_ENOBOOT          SILOFS_DEFERR2(5)
#define SILOFS_EBADBOOT         SILOFS_DEFERR2(6)
#define SILOFS_EMOUNT           SILOFS_DEFERR2(7)
#define SILOFS_EUMOUNT          SILOFS_DEFERR2(8)
#define SILOFS_ENORX            SILOFS_DEFERR2(9)
#define SILOFS_ENOTX            SILOFS_DEFERR2(10)
#define SILOFS_ECSUM            SILOFS_DEFERR2(11)
#define SILOFS_ERDONLY          SILOFS_DEFERR2(12)
#define SILOFS_ELSEG            SILOFS_DEFERR2(13)
#define SILOFS_ENOTDONE         SILOFS_DEFERR2(14)
#define SILOFS_ECOMPRESS        SILOFS_DEFERR2(15)
#define SILOFS_EDECOMPRESS      SILOFS_DEFERR2(16)
