...
#define vaddr_stype(va)                 silofs_vaddr_stype(va)
#define vaddr_lba(va)                   silofs_vaddr_lba(va)
...
#define ii_undirtify(ii)                silofs_ii_undirtify(ii)
