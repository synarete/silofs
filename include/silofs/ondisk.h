...
enum silofs_vtype {
	...
	SILOFS_VTYPE_MBR     = 1,
	SILOFS_VTYPE_ARIX    = 2,
	SILOFS_VTYPE_SUPER   = 3,
	SILOFS_VTYPE_SPNODE  = 4,
	SILOFS_VTYPE_SPLEAF  = 5,
	SILOFS_VTYPE_LSMAP   = 6,
	SILOFS_VTYPE_INODE   = 7,
	SILOFS_VTYPE_XANODE  = 8,
	SILOFS_VTYPE_DTNODE  = 9,
	SILOFS_VTYPE_SYMVAL  = 10,
	SILOFS_VTYPE_FTNODE  = 11,
