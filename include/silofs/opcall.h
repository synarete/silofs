...
struct silofs_args {
	union silofs_args_in  in;
	union silofs_args_out out;
	long                  ioc_cmd;
} silofs_attr_aligned64;

typedef int (*silofs_call_fn)(struct silofs_task *, struct silofs_args *);
