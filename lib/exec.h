...
int silofs_exec_forget(struct silofs_exec_ctx *exct, ino_t ino,
                       size_t nlookup);
...
int silofs_exec_rename(struct silofs_exec_ctx *exct, ino_t parent,
...
int silofs_exec_restore(struct silofs_exec_ctx    *exct,
