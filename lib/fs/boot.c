...
static void bsec1k_sb_blobid(const struct silofs_bootsec1k *bsc,
                             struct silofs_blobid *out_blobid)
{
	silofs_blobid40b_parse(&bsc->bs_sb_packid, out_blobid);
}

static void bsec1k_set_sb_blobid(struct silofs_bootsec1k *bsc,
                                 const struct silofs_blobid *blobid)
{
	silofs_blobid40b_set(&bsc->bs_sb_packid, blobid);
}
