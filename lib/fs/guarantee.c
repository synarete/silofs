...
{
	REQUIRE_SIZEOF_4K(struct silofs_super_block);
...
static void guarantee_persistent_types_size(void)
{
	...
	REQUIRE_SIZEOF(struct silofs_treeid192, SILOFS_TREEID_SIZE);
...
static void guarantee_persistent_types_alignment2(void)
{
	...
	REQUIRE_OFFSET64(struct silofs_bootsec1k, bs_sb_packid, 320);
	REQUIRE_OFFSET64(struct silofs_bootsec1k, bs_rands, 384);
	REQUIRE_OFFSET64(struct silofs_bootsec1k, bs_metaname, 512);
	...
	REQUIRE_OFFSET64(struct silofs_super_block, sb_self_uaddr, 1024);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_stats_uaddr, 1088);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_mainblobid, 1152);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_mainpackid, 1216);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_treeid, 1280);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_vrange, 1312);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_itable_root, 1328);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_birth_time, 1336);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_clone_time, 1344);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_pack_time, 1352);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_itnode, 2048);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_inode, 2112);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_xanode, 2176);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_dtnode, 2240);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_ftnode, 2304);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_symval, 2368);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_data1k, 2432);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_data4k, 2496);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_databk, 2560);
	...
	REQUIRE_OFFSET64(struct silofs_spmap_node, sn_stype_sub, 16);
	REQUIRE_OFFSET64(struct silofs_spmap_node, sn_mainblobid, 24);
	REQUIRE_OFFSET64(struct silofs_spmap_node, sn_mainpackid, 64);
	...
	REQUIRE_OFFSET64(struct silofs_spmap_leaf, sl_stype_sub, 16);
	REQUIRE_OFFSET64(struct silofs_spmap_leaf, sl_mainblobid, 24);
	REQUIRE_OFFSET64(struct silofs_spmap_leaf, sl_mainpackid, 64);
