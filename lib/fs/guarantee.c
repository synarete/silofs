...
static void guarantee_persistent_types_alignment2(void)
{
	...
	REQUIRE_OFFSET64(struct silofs_super_block, sb_sproot_uaddr, 1152);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_mainblobid, 1216);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_mainpackid, 1280);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_treeid, 1344);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_vrange, 1376);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_itable_root, 1392);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_birth_time, 1400);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_clone_time, 1408);
	REQUIRE_OFFSET64(struct silofs_super_block, sb_pack_time, 1416);
