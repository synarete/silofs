...
static void
sb_lv_base(const struct silofs_super_block *sb, union silofs_blobid *out_vid)
{
	silofs_blobid_assign(out_vid, &sb->sb_lv_base);
}

static void
sb_set_lv_base(struct silofs_super_block *sb, const union silofs_blobid *vid)
{
	silofs_blobid_assign(&sb->sb_lv_base, vid);
}

static void
sb_lv_prev(const struct silofs_super_block *sb, union silofs_blobid *out_vid)
{
	silofs_blobid_assign(out_vid, &sb->sb_lv_prev);
}

static void
sb_set_lv_prev(struct silofs_super_block *sb, const union silofs_blobid *vid)
{
	silofs_blobid_assign(&sb->sb_lv_prev, vid);
}

static void
sb_lv_curr(const struct silofs_super_block *sb, union silofs_blobid *out_vid)
{
	silofs_blobid_assign(out_vid, &sb->sb_lv_curr);
}

static void
sb_set_lv_curr(struct silofs_super_block *sb, const union silofs_blobid *vid)
{
	silofs_blobid_assign(&sb->sb_lv_curr, vid);
}

static void
sb_set_lv_ids(struct silofs_super_block *sb, const union silofs_blobid *vid)
{
...
static void
sb_init(struct silofs_super_block *sb, const union silofs_blobid *vid)
{
...
static const union silofs_blobid *sbi_lvid(const struct silofs_sb_info *sbi)
{
