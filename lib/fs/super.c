...
static void
sb_init(struct silofs_super_block *sb, const union silofs_blobidu *vid)
{
...
static void uaddr_setup_super(struct silofs_uaddr *out_uaddr,
                              const union silofs_blobidu *vid)
{
...
static const union silofs_blobidu *sbi_lvid(const struct silofs_sb_info *sbi)
{
