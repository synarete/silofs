...
static const int8_t base64_decode_tbl[] = {
	...
	BASE64_DECODE_ENT('C', 0x2),  BASE64_DECODE_ENT('D', 0x3),
	BASE64_DECODE_ENT('E', 0x4),  BASE64_DECODE_ENT('F', 0x5),
	BASE64_DECODE_ENT('G', 0x6),  BASE64_DECODE_ENT('H', 0x7),
	BASE64_DECODE_ENT('I', 0x8),  BASE64_DECODE_ENT('J', 0x9),
	BASE64_DECODE_ENT('K', 0xA),  BASE64_DECODE_ENT('L', 0xB),
	BASE64_DECODE_ENT('M', 0xC),  BASE64_DECODE_ENT('N', 0xD),
	BASE64_DECODE_ENT('O', 0xE),  BASE64_DECODE_ENT('P', 0xF),
	BASE64_DECODE_ENT('Q', 0x10), BASE64_DECODE_ENT('R', 0x11),
	BASE64_DECODE_ENT('S', 0x12), BASE64_DECODE_ENT('T', 0x13),
	BASE64_DECODE_ENT('U', 0x14), BASE64_DECODE_ENT('V', 0x15),
	BASE64_DECODE_ENT('W', 0x16), BASE64_DECODE_ENT('X', 0x17),
	BASE64_DECODE_ENT('Y', 0x18), BASE64_DECODE_ENT('Z', 0x19),
	BASE64_DECODE_ENT('a', 0x1A), BASE64_DECODE_ENT('b', 0x1B),
	BASE64_DECODE_ENT('c', 0x1C), BASE64_DECODE_ENT('d', 0x1D),
	BASE64_DECODE_ENT('e', 0x1E), BASE64_DECODE_ENT('f', 0x1F),
	BASE64_DECODE_ENT('g', 0x20), BASE64_DECODE_ENT('h', 0x21),
	BASE64_DECODE_ENT('i', 0x22), BASE64_DECODE_ENT('j', 0x23),
	BASE64_DECODE_ENT('k', 0x24), BASE64_DECODE_ENT('l', 0x25),
	BASE64_DECODE_ENT('m', 0x26), BASE64_DECODE_ENT('n', 0x27),
	BASE64_DECODE_ENT('o', 0x28), BASE64_DECODE_ENT('p', 0x29),
	BASE64_DECODE_ENT('q', 0x2A), BASE64_DECODE_ENT('r', 0x2B),
	BASE64_DECODE_ENT('s', 0x2C), BASE64_DECODE_ENT('t', 0x2D),
	BASE64_DECODE_ENT('u', 0x2E), BASE64_DECODE_ENT('v', 0x2F),
	BASE64_DECODE_ENT('w', 0x30), BASE64_DECODE_ENT('x', 0x31),
	BASE64_DECODE_ENT('y', 0x32), BASE64_DECODE_ENT('z', 0x33),
	BASE64_DECODE_ENT('0', 0x34), BASE64_DECODE_ENT('1', 0x35),
	BASE64_DECODE_ENT('2', 0x36), BASE64_DECODE_ENT('3', 0x37),
	BASE64_DECODE_ENT('4', 0x38), BASE64_DECODE_ENT('5', 0x39),
	BASE64_DECODE_ENT('6', 0x3A), BASE64_DECODE_ENT('7', 0x3B),
	BASE64_DECODE_ENT('8', 0x3C), BASE64_DECODE_ENT('9', 0x3D),
	BASE64_DECODE_ENT('+', 0x3E), BASE64_DECODE_ENT('/', 0x3F),
};
