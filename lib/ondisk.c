...
static void validate_ondisk_pndptr(void)
{
	...
	REQUIRE_OFFSET64(struct silofs_pndptr192b, np_nmeta, 0);
	REQUIRE_OFFSET64(struct silofs_pndptr192b, np_paddr, 128);
	REQUIRE_SIZEOF(struct silofs_pndptr192b, 192);
}
