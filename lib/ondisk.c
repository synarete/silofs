...
{
	REQUIRE_OFFSET64(struct silofs_btstate384b, bts_root, 0);
	REQUIRE_OFFSET64(struct silofs_btstate384b, bts_nextfree, 256);
	REQUIRE_SIZEOF(struct silofs_btstate384b, 384);
