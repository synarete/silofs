...
static void bti_setdirty(struct silofs_btnode_info *bti)
{
	silofs_pni_setdirty(&bti->btn_pni);
}

static void
bti_setdirty2(struct silofs_btnode_info *bti1, struct silofs_btnode_info *bti2)
{
	bti_setdirty(bti1);
	bti_setdirty(bti2);
}
