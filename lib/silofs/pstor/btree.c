...
struct silofs_btree_ctx {
	...
	const struct silofs_exec_refs *xrefs;
	struct silofs_uber_info *ubi;
	uint64_t key;
};

static void
btc_init(struct silofs_btree_ctx *btc, const struct silofs_exec_refs *xrefs,
...
{
	return silofs_stage_btnode(btc->xrefs, pnptr, out_bti);
}
...
static int btc_spawn_btnode_at(const struct silofs_btree_ctx *btc,
                               ...
                               struct silofs_btnode_info **out_bti)
{
	return silofs_spawn_btnode(btc->xrefs, pnptr, out_bti);
}
                             ...
                             struct silofs_pnptr *out_pnptr)
{
	...
	return silofs_carve_btspace_pnptr(btc->xrefs, btc_vspace(btc),
	                                  out_pnptr);
}
