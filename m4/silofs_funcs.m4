...
[
  AX_SILOFS_CHECK_FUNCS([aligned_alloc])
  ...
  AX_SILOFS_CHECK_FUNCS([secure_getenv])
  AX_SILOFS_CHECK_FUNCS([select])
  AX_SILOFS_CHECK_FUNCS([sem_destroy])
  AX_SILOFS_CHECK_FUNCS([sem_init])
  AX_SILOFS_CHECK_FUNCS([sem_timedwait])
  AX_SILOFS_CHECK_FUNCS([sem_wait])
  ...
  AX_SILOFS_CHECK_FUNCS([strftime])
  AX_SILOFS_CHECK_FUNCS([strlcpy])
