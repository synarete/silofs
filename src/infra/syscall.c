...
int silofs_sys_fstatat(int dirfd, const char *path, struct stat *st, int flags)
{
...
int silofs_sys_preadv(int fd, const struct iovec *iov, int iovcnt,
...
int silofs_sys_mmap_anon(size_t length, int xflags, void **out_addr)
{
	...
	return silofs_sys_mmap(NULL, length, prot,
