 ...
 */
#ifndef SILOFS_FNCTESTS_H_
#define SILOFS_FNCTESTS_H_
...
#include "fnctests_inline.h"

/* system-calls wrappers */
#include "fnctests_syscall.h"

/* expect utilities */
#include "fnctests_expect.h"

#endif /* SILOFS_FNCTESTS_H_ */
