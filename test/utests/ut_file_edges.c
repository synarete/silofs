...
#define FIMAP_SZ     (UT_FILEMAP_NCHILDS * UT_64K)
...
static void ut_file_edges_fmapping(struct ut_env *ute)
{
	long off_arr[] = {
		...
		UT_64K,
		2 * UT_64K,
		UT_64K * UT_FILEMAP_NCHILDS,
		UT_64K * (UT_FILEMAP_NCHILDS + 1),
		UT_64K * 2 * UT_FILEMAP_NCHILDS,
		UT_64K * ((2 * UT_FILEMAP_NCHILDS) + 1),
		UT_64K * UT_FILEMAP_NCHILDS * UT_FILEMAP_NCHILDS,
		UT_FILESIZE_MAX / 2,
		UT_FILESIZE_MAX - UT_64K,
	};
