...
void ut_sync_drop(struct ut_env *ute)
{
	...
	err = silofs_sync_fs(ute->env, true);
	ut_expect_ok(err);
}
...
void ut_format_fs(struct ut_env *ute)
{
	...
	err = silofs_format_fs(ute->env, &ute->fs_blobid[0]);
	ut_expect_ok(err);
}
...
void ut_open_fs(struct ut_env *ute)
{
	...
	err = silofs_open_fs(ute->env, &ute->fs_blobid[0]);
	ut_expect_ok(err);
}
...
void ut_open_fs2(struct ut_env *ute)
{
	...
	err = silofs_open_fs(ute->env, &ute->fs_blobid[1]);
	ut_expect_ok(err);
}
...
void ut_remove_fs(struct ut_env *ute)
{
	...
	err = silofs_remove_fs(ute->env, &ute->fs_blobid[0]);
	ut_expect_ok(err);
}
...
void ut_remove_fs2(struct ut_env *ute)
{
	...
	err = silofs_remove_fs(ute->env, &ute->fs_blobid[1]);
	ut_expect_ok(err);
}
...
void ut_fork_fs(struct ut_env *ute)
{
	...
	err = silofs_fork_fs(ute->env, &ute->fs_blobid[0], &ute->fs_blobid[1]);
	ut_expect_ok(err);
}
...
void ut_archive_fs(struct ut_env *ute)
{
	...
	err = silofs_archive_fs(ute->env, &ute->fs_blobid[0], &ute->ar_blobid);
	ut_expect_ok(err);
}
...
void ut_restore_fs(struct ut_env *ute)
{
	...
	err = silofs_restore_fs(ute->env, &ute->ar_blobid, &ute->fs_blobid[0]);
	ut_expect_ok(err);
}
