...
void ut_close_repo_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_close_repo(ute->fs_env);
	ut_expect_ok(err);
}
...
void ut_format_fs_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_format_fs(ute->fs_env, &ute->uuid[0]);
	ut_expect_ok(err);
}
...
void ut_open_fs_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_boot_fs(ute->fs_env, &ute->uuid[0]);
	ut_expect_ok(err);
...
void ut_open_fs2_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_boot_fs(ute->fs_env, &ute->uuid[1]);
	ut_expect_ok(err);
...
void ut_inspect_fs_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_inspect_fs(ute->fs_env);
	ut_expect_ok(err);
}
...
void ut_unref_fs2_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_unref_fs(ute->fs_env, &ute->uuid[1]);
	ut_expect_ok(err);
}
...
void ut_fork_fs_ok(struct ut_env *ute)
{
	...
	err = silofs_fse_fork_fs(ute->fs_env, &ute->uuid[0], &ute->uuid[1]);
	ut_expect_ok(err);
}
